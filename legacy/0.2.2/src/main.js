define(["modernoo"], function (M) {
    ...
    const Lib = window.Lib = M(function (core, base) {
        ...
        core("pubsub.customEvent", function (Y, NAME) {
            const subs = [];
        ...
        add("some-service", function SomeService(Y) {
